...
final class SickLeaveTable extends PowerGridComponent
{
    ...
    {
        return SickLeave::query()->with('employee');
    }
    ...
    public function actions(SickLeave $row): array
    {
        return [
            Button::add('edit')
                ->render(function ($rowId) {
                    return Blade::render(<<<HTML
                    <x-success-button onclick="Livewire.dispatch('ModalEditSick', { id:  {$rowId->id}  })"><i class="fa-sharp fa-solid fa-pen-to-square"></i></x-success-button>
                HTML);
                }),
            ...
            Button::add('delete')
                ->render(function ($rowId) {
                    return Blade::render(<<<HTML
                    <x-danger-button onclick="Livewire.dispatch('ModalDeleteSick', { id:  {$rowId->id}  })"><i class="fa-sharp fa-solid fa-trash"></i></x-danger-button>
                HTML);
                }),
        ];
    }
